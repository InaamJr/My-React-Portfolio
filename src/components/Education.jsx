...
const Education = () => {
  return (
    <section id="education" className="container mx-auto py-16 tracking-tighter">
              ...
              <div key={index} className="mb-14 flex flex-wrap lg:justify-center">
                ...
                <motion.div 
                  ...
                  {education.courses.map((course, index) => (
                    <span key={index} className="mr-2 mt-4 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-purple-900">{course}</span>
                  ))}
                </motion.div>
              </div>
            ))}
